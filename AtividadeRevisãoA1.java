...
class AtividadeRevisãoA1 {
  public static void main(String[] args) {
    ...
    System.out.println("\tRelatório Auxiliar de Controle de possíveis Infecções");
    ...
    if (erroTentativas == false) {
      ...
      do {
        System.out
            .println("\nTeve contato com pessoas com sintomas de gripe nos últimos dias?" +
                "Digite SIM ou NAO");
    ...
    if (erroTentativas == true) {
      System.out.println("Não foi possível realizar o diagnóstico." +
          "Favor procurar ajuda médica caso apareça algum sintoma.");
    } else {

      if (estaRetornandoViagem.equals("SIM")) {
        porcentagemInfeccao += 30;
        orientacaoFinal = "Você ficará sob observação por 5 dias.";
      }
